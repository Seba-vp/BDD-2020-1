<?php
  ...
  if (isset($_POST['submit'])) {
   ...
   foreach ($info_lugar as $i) {
    ...
    #Buscar artistas
    $queryartistas = "SELECT DISTINCT nombre_artista_creador, id_artista FROM obras JOIN artistas ON nombre_artista_creador LIKE %nombre_artista% WHERE lugar_exhibicion='$nombre_lugar';";
